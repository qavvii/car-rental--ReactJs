...
const Navigation = () => {
  ...
  return (
    <div>
      <div className="wrapper flex justify-between items-center py-0.5">
        <img src={cars} width="100px" height="100px" alt="" />
        ...
        <div className="hidden lg:flex items-center gap-[30px]">
          <button className="btn_base text-primary-black hover:text-primary-yellow">
            Login
          </button>
          <button
            className="btn_base text-primary-black border-2 border-primary-yellow
            rounded-full py-2 px-5 hover:bg-primary-green hover:border-transparent hover:text-white"
          >
            Sign Up
          </button>
